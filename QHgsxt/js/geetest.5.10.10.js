...
function(a, b) {
	...
	k.b = {}, k.b.global = {}, k.z = function(a) {
		...
		var c, d = k.b[b][a];
		if (d) for (var e = 0; e < d.length; e++) c = d[e], c && (c.callback.call(Q.t("self", b)), c.once && (k.C(a, c, b), e -= 1))
	}, k.y = function(a) {
		var b, c = k.b.global[a];
		if (c) for (var d = 0; d < c.length; d++) b = c[d], b && (b.callback(), b.once && (k.C(a, b), d -= 1))
	};
	var l = function(a, b) {
			var c = b || {};
	...
	S.H = function ua(a, b, c) {
		...
		var d = function() {
				var d = new Date,
					...
					h = 0,
					i = function() {
						if (!(h < e)) if (g) a.config.retry += 1, Q.G("status", "auto", a.id), a.refresh();
						else {
							a.config.retry = 0;
	...
	ba.evts = {
		...
		for (var c, d = 0, e = ba.b.length; d < e; d++) if (c = ba.b[d], c.dom == a && c.event == b) return c;
		return c = {
			dom: a,
			event: b,
			handlerList: [],
	...
	return c.prototype.zoom = function(a) {
		...
		var c = "1234567890.",
			d = function(a) {
				for (var b = 0, d = a.length; b < d; b += 1) if (c.indexOf(a[b]) === -1) return !1;
				return !0
			};
